        ...
        <div class="max-w-5xl mx-auto">
          ...
          <template x-if="!loading && filteredJobs.length === 0">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
              ...
              <a href="dashboard.php" class="inline-flex items-center gap-2 mt-3 px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold transition">
